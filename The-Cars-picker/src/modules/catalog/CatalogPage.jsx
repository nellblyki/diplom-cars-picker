...
export function CatalogPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-xl font-semibold">Каталог автомобилей</h1>
      <p className="text-sm text-slate-400">
        Небольшой каталог на основе локального JSON. В реальном проекте здесь
        были бы результаты с автомобильных маркетплейсов.
      </p>

      {loading && <p className="text-sm text-slate-400">Загружаем каталог…</p>}
      {error && (
